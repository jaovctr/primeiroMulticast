...
public class AtvMulticastServer2 {
	public static void main(String[] args) {
		...
		try {
			...
			endCliente = inPacket.getAddress();

			long espera = System.currentTimeMillis();
			while (System.currentTimeMillis() - espera < 10000) {
				System.out.println("aguaradando server 1");
				inSocket.receive(inPacket);

				if (!endCliente.equals(inPacket.getAddress())) {
			...
			if (s1offline) {
				System.out.println("Server 1 fora do ar");
				try {
